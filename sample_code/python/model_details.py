...
class ModelDetails(BaseModel):
    ...
    precision: Annotated[Optional[str], Field(default=None, description="Precision of the model (e.g., 'fp16', 'bf16')")] = None
    """Precision of the model (e.g., 'fp16', 'bf16')"""
    specialization: Annotated[Optional[str], Field(default=None, description="Specialization of the model (e.g., 'LoRA', 'Embedding', 'TextToImage', 'Audio', 'Vision')")] = None
